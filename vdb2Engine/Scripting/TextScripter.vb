Public Class TextScripter
  ...
  Public Function CCreateIndex1(ByVal indexDiff As Object) As String Implements ICommon.IScripter.CCreateIndex
    If TypeOf indexDiff Is IndexDiff Then
      Return "Index: " & CType(indexDiff, IndexDiff).Name
    Else
      Return ""
    End If
  End Function
