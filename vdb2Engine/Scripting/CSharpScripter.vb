Public Class CSharpScripter
  ...
  'Private Const IS_INDEX_EXISTS As String = "If (!(t.IsIndexExists(""{0}""))) {"
  Private Const CREATE_INDEX As String = "t.CreateIndex(""{0}"", ""{1}"", {2}, {3}, {4});"
  Private Const CLOSE_TABLE As String = "If (t.Opened) {t.Close();}"
  ...
  Public ReadOnly Property ScriptHeader() As String Implements vDBCompare.ICommon.IScripter.ScriptHeader
    Get
      ...
      sb.AppendLine("VistaDB.VistaDBTable t;")
      ...
      sb.AppendLine("if (db.Exclusive == false) { ")
      sb.AppendLine("  if (db.Connected) { ")
  ...
  Public Function CIfTableExists(ByVal tableName As String, ByVal equals As Boolean) As String Implements vDBCompare.ICommon.IScripter.CIfTableExists
    ...
    Return "If ((db.IsTableExist(""" & tableName & """)) == " & equals.ToString.ToLower & ") {"
  ...
  End Function
	...
	Public Function CSetDefault(ByVal columnName As String, ByVal defaultValue As String, ByVal useInUpdates As Boolean) As String Implements vDBCompare.ICommon.IScripter.CSetDefault
  ...
  Public Function CIsIndexExists(ByVal indexName As String) As String Implements vDBCompare.ICommon.IScripter.CIsIndexExists
    ...
    Return "If (!(t.IsIndexExists(""" & indexName & """))) {"
  End Function
  ...
  Public Function CCreateIndex(ByVal index As Object) As String Implements ICommon.IScripter.CCreateIndex
    If TypeOf index Is IndexDiff Then
      ...
      'Return CCreateIndex(idx.Name, idx.KeyExpr, "VistaDB.VDBIndexOption." & idx.IndexType.ToString, idx.Descending, 0)
